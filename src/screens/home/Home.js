...
class Home extends Component{
  ...
  render(){
    ...
    {
      torender= <GridList className={classes.gridList} cellHeight={'auto'}>
    ...
    return(
      <div className="home-item-main-container">
        <Card className={classes.card}>
          <CardHeader
            avatar={
              <Avatar alt="User Profile Pic" src={profilePic} className={classes.avatar}/>
            }
            title={item.username}
            subheader={time}
          />
          <CardContent>
            ...
            <CardActions>
              <IconButton aria-label="Add to favorites" onClick={this.likeClickHandler}>
                {this.state.isLiked? <FavoriteIconFill style={{color:'#F44336'}} />:<FavoriteIconBorder/>}
              </IconButton>
              <Typography component="p">
            ...
            <div className={classes.formControl}>
              ...
              <FormControl>
                <Button onClick={this.onAddCommentClicked.bind(this,item.id)} style={{marginLeft:'10px'}}

                ...
                <div className="information-section">
                    ...
                    <span style={{marginLeft: "20px"}}>
                        <div style={{width: "600px", fontSize: "big"}}> {this.state.username} <br />
                            ...
                            <div style={{float: "left", width: "200px", fontSize: "small"}}> Follows: {360} </div>
                            <div style={{float: "left", width: "200px", fontSize: "small"}}> Followed By: {896}</div> <br />
                        </div>
                        <div style={{fontSize: "large"}}>{this.state.full_name}
